        ...
        <form onSubmit={handleSignUp} className="flex flex-col gap-5">
          ...
          <div className="relative">
            <input
              ...
              required
            />
            <label className="absolute left-4 top-4 text-white/50 peer-placeholder-shown:top-4 peer-placeholder-shown:text-white/50 peer-focus:top-1 peer-focus:text-sm peer-focus:text-pink-400 transition-all duration-300">Full Name</label>
          </div>
